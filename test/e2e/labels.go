...
func verifyLabels(
	...
	verifyImageLabel(g, operatorImage, images.operator, "ghcr.io/au-ee/operator-controller:")
	instrumentationImage := readLabel(g, namespace, runtime, workloadType, "dash0.com/instrumentation-image")
	verifyImageLabel(g, instrumentationImage, images.instrumentation, "ghcr.io/au-ee/instrumentation:")
